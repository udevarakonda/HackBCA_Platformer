...
# Comptuer Path, can be changed to fit your computer
COMPUTER_PATH = "/Users/udbhav/Desktop/"

# Total Points for Each Level
MAX_SCORE_LIST = [385, 427, 518]

# Keep Track of the Current Level Externally
THE_CURRENT_LEVEL = 1
...
class MainMenu(arcade.View):
    ...
    def on_draw(self):
        ...
        self.clear()
        arcade.draw_text(
            "Arrow Keys to move, Q to shoot. If you hit a zombie or robot, you die",
            SCREEN_WIDTH / 2,
            SCREEN_HEIGHT / 2 - 200,
            arcade.color.BLACK,
            font_size=20,
...
class GameView(arcade.View):
    ...
    def __init__(self):
        ...
        self.current_level = THE_CURRENT_LEVEL
    ...
    def setup(self):
        ...
        # Map name
        map_name = COMPUTER_PATH + f"HackBCA_Platformer/source_code/Platformer_Resources/tiled_maps/Level{self.current_level}.json"
    ...
    def on_update(self, delta_time):
        ...
        if self.score >= MAX_SCORE_LIST[int(self.current_level)-1]:
            global THE_CURRENT_LEVEL
            if THE_CURRENT_LEVEL == 3:
                arcade.play_sound(self.collect_coin_sound)
                game_end = GameEndView()
...
class GameEndView(arcade.View):
    ...
    def on_draw(self):
        ...
        self.clear()
        arcade.draw_text(
            "You Beat the Game - Click to Restart",
            SCREEN_WIDTH / 2,
            SCREEN_HEIGHT / 2,
            arcade.color.WHITE,
            40,
